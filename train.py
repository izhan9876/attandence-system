...
message = tk.Label(window, text="FACE RECOGNITION ATTENDANCE SYSTEM" ,bg="white"  ,fg="black"  ,width=50  ,height=3,font=('times', 35, ' bold')) 

message.place(x=70, y=22)
...
def TrackImages():
    ...
    recognizer.read("face-trainner.xml")
    harcascadePath = "haarcascade_frontalface_default.xml"
...
trainImg = tk.Button(window, text="Attendance Files", command=TrainImages  ,fg="black"  ,bg="white"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
...
copyWrite = tk.Label(window, text="(Created By md izhan uddin )",
